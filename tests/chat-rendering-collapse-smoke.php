...
$assert( str_contains( $source, 'getMostRecentSession( chat.sessions )' ) && str_contains( $source, 'chat.loadSession( latestSession.id );' ), 'latest conversation still restores on startup' );
